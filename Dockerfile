...
ENV dummy dumm
RUN sudo apt-get update && apt-get upgrade && apt-get dist-upgrade && sudo apt-get -y install gettext-base make gcc build-essential
...
RUN sudo chmod 600 ~/.ssh && sudochmod 600 ~/.ssh/known_hosts
